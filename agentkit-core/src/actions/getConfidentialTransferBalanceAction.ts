...
import { BalanceParams, TokenConfig, BalanceChecker, SUPPORTED_CHAINS, SUPPORTED_TOKENS } from 'petcrypt-js-lite';
...
const getConfidentialTokenBalance = async (smartAccount: `0x${string}`): Promise<BalancePayload> => {
