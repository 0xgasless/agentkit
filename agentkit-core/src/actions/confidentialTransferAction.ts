...
import { depositContractMappings, tokenMappings } from "../constants";
...
export const SmartConfidentialTransferInput = z
  .object({
    ...
    destinationAddress: z.string().describe("The address to which the tokens will be transferred"),
  })
  .strip()
  .describe(
 ...
 */
export class SmartConfidentialTransferAction
  implements AgentkitAction<typeof SmartConfidentialTransferInput>
{
